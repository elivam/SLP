...
(defun child-parents (name-child mather father)
    (setf (get name-child 'm) mather)
...
(child-parents 'Alim 'Asye 'Han )
(child-parents 'Ilim 'Asye 'Esat)
(child-parents 'Amet 'Syrie 'Esat)
